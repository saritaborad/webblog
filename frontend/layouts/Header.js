...
const Header = () => {
 ...
 return (
  <>
   <header className={`sticky top-0 z-50 bg-white py-2 transition-all ${navFixed ? "shadow" : "pt-8 md:pt-16"}`}>
    <nav className="navbar container">
     ...
     <label id="hide-button" htmlFor="nav-toggle" className="d-flex align-items-center d-md-order-1 d-md-none order-2 cursor-pointer">
      <svg className="h-6 fill-current" viewBox="0 0 20 20">
